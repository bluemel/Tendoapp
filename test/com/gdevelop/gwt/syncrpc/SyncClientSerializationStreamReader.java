...
public class SyncClientSerializationStreamReader extends AbstractSerializationStreamReader {
	...
	public void prepareToRead(String encoded) throws SerializationException {
		...
		if ((getVersion() < SERIALIZATION_STREAM_MIN_VERSION) || (getVersion() > SERIALIZATION_STREAM_VERSION)) {
			throw new IncompatibleRemoteServiceException("Expecting version between "
					+ SERIALIZATION_STREAM_MIN_VERSION + " and " + SERIALIZATION_STREAM_VERSION + " from server, got "
					+ getVersion() + ".");
		}
	...
	private Object instantiate(Class<?> customSerializer, Class<?> instanceClass) throws InstantiationException,
	...
	protected Object deserialize(String typeSignature) throws SerializationException {
		System.out.println("@@@ sig = " + typeSignature);
		...
		try {
			...
			// false, null);
			System.out.println("@@@ " + serializedInstRef.getName());
